...
<div style = "background-image:url('images/image33.jpg'); min-height:100%;position:relative;background-position:center;background-size:cover;background-repeat:no-repeat;background-attachment:fixed;height:800px;">
...
<div class = "container" style="padding-top:13%;height:758px;">
        ...
        <div class = "form-group">
          <label style = "color:#000;font-weight: bold;">Username : </label>
          ...
          <div class="row">
            <div class = "col">
              <div style = "margin-left: 34%;margin-top: 30px;">
                <button type = "submit" class = "btn btn-primary" style="width:200px;color:#000;" name ="signIn" data-toggle="modal" data-target ="#demo" >Sign In</button>
              </div>
            </div>
          </div>
          <p style = "margin-top: 10px;font-weight: bold;">
            <a href="signUp.php"style = "color:#000;" >New to Dyscipher ?</a>
          </p>
